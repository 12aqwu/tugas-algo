...
int main (){
    ...
    string daftar_barang[] = {"Novel", "Komik", "Dongeng", "Cergam", "Biografi"}; 
...
switch(pilihmenu){
	case 1:
		...
		cout << "=====    TOKO buku bekas  =====" << endl;
		cout << "=================================" << endl;
		cout << "1. Novel         : Rp. 250.000" << endl;
		cout << "2. Komik         : Rp. 600.000" << endl;
		cout << "3. Dongeng       : Rp. 200.000" << endl;
		cout << "4. Cergam        : Rp. 300.000" << endl;
		cout << "5. Biografi      : Rp. 200.000" << endl;
		cout << endl;		
	break ;
	...
	case 5:
		...
		cout << endl;
		cout << "TERIMA KASIH TELAH BERBELANJA DI TOKO buku bekas  " << endl;
		}		
	break;
